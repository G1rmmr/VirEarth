...
void UHand_Tracking::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	Pipeline->Stop();
...
// Called every frame
void UHand_Tracking::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
int32 UHand_Tracking::GetFingers()
{
